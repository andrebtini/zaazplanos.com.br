...
$faqs = [
    ...
    [
        ...
        'a' => 'O roteador fica em comodato (empréstimo gratuito) durante o período da assinatura. Enquanto você for cliente, ele é seu para usar.',
    ],
    [
    ...
    [
        ...
        'a' => 'Suporte 24 horas por dia, 7 dias por semana, via WhatsApp ou telefone. Nossa equipe é local e conhece a infraestrutura da região.',
    ],
    [
        'q' => 'O Zaaz Play e o Zaaz Educa já estão inclusos?',
        'a' => 'Sim. Todos os planos incluem Zaaz Play (streaming com filmes, séries e canais ao vivo) e Zaaz Educa (plataforma de cursos e videoaulas), sem custo adicional.',
    ],
];
...
<section id="faq" class="v3-faq" aria-labelledby="v3-faq-heading">
    <div class="container">
        <span class="section-label">FAQ</span>
        <h2 class="section-title" id="v3-faq-heading">PERGUNTAS<br>FREQUENTES.</h2>
        <p class="section-desc">Tudo o que você precisa saber antes de contratar.</p>

        <div class="v3-faq-list" role="list">
            <?php foreach ($faqs as $faq): ?>
            <details class="v3-faq-item" role="listitem">
                <summary class="v3-faq-summary"><?= htmlspecialchars($faq['q']) ?></summary>
                <p class="v3-faq-body"><?= htmlspecialchars($faq['a']) ?></p>
            </details>
            <?php endforeach; ?>
        </div>
    </div>
